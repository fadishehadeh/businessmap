      ...
      <div className="container-wide relative z-10 h-screen flex flex-col justify-center">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
            <Button
              asChild
              className="bg-qatari hover:bg-qatari-light text-white px-6 py-6 text-base focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-qatari"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="bg-white/10 backdrop-blur-sm border-white text-white hover:bg-white/20 px-6 py-6 text-base focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
            >
